  ...
  <!-- Page Content -->
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">About - Información
                    <small>About the project - Sobre el proyecto</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-md-10 ortfolio-item">
                <p>This was made in an informative way, trying to be weekly</p>
                <p>Esto fue hecho de un modo informativo, tratando de ser semanal</p>
            </div>
        </div>
        <!-- /.row -->
