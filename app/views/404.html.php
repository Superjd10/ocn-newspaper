...
<head>
    ...
    <meta name="description" content="OCN's newspaper with weekly info">
    <meta name="author" content="Superjd10">

    <title>404 Not Found - No encontrado | <?php echo config('blog.title') ?></title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">404
                    <small>Not found - No encontrado</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; Superjd10 2015</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
